...
<template>
    <div class="mt-12">  
        <form class="max-w-md p-4 mx-auto bg-white rounded-md shadow-md" @submit.prevent="storeSkill(form)">
            <div class="space-y-6">
                <div class="mb-6">
                ...
                <div class="mb-6">
                    ...
                    <input type="text" v-model="form.slug" id="slug" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
